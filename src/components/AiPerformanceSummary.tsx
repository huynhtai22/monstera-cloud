...
export function AiPerformanceSummary({ workspaceId }: Props) {
    ...
    return (
        <div className="rounded-2xl border border-indigo-100/90 bg-gradient-to-br from-indigo-50/90 to-white p-6 shadow-sm dark:border-indigo-900/40 dark:from-indigo-950/30 dark:to-slate-900/40">
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="flex items-start gap-3">
                    <div className="rounded-xl bg-indigo-100 p-2 dark:bg-indigo-950/80">
                        <Sparkles className="h-5 w-5 text-indigo-600 dark:text-indigo-300" />
                    </div>
                    <div>
                        <h2 className="text-sm font-bold text-gray-900 dark:text-white">AI digest (last 7 days)</h2>
