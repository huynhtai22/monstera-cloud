            ...
            <div className="rounded-2xl border border-white/10 bg-slate-800/40 backdrop-blur-sm p-6">
                ...
                <div className="space-y-4">
                    {MOCK_TEAM.map(member => (
                        <div key={member.id} className="flex items-center justify-between p-4 rounded-xl border border-white/5 bg-slate-900/40">
                            <div className="flex items-center space-x-4">
                                <div className="w-10 h-10 rounded-full bg-cyan-500/10 flex items-center justify-center text-cyan-400 font-medium">
                            ...
                            <div className="flex items-center space-x-4">
                                <span className="text-xs font-medium px-2.5 py-1 rounded-md bg-slate-700/60 text-slate-300">
                                    {member.role}
                                </span>
                                {member.role !== 'Admin' && (
