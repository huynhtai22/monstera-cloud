        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#16181c]/40 backdrop-blur-sm shadow-sm overflow-hidden">
                        <div className="p-4 border-b border-slate-100 dark:border-white/10 flex justify-between items-center bg-slate-50/80 dark:bg-[#000000]/40">
                        ...
                        {isAddingClient && (
                            <div className="p-4 rounded-xl bg-white dark:bg-[#000000]/60 border border-slate-100 dark:border-white/5">
                        ...
                        <div className="divide-y divide-white/5 px-4 pb-4">
                            {clients.length === 0 ? (
                                ...
                                <div key={client.id} className="p-5 hover:bg-gray-50/50 dark:hover:bg-[#16181c]/30 transition-colors">
                                    ...
                                    <div className="space-y-2">
                                        {client.connections?.map((conn: any) => (
                                            <div key={conn.id} className="flex items-center justify-between text-xs p-2.5 rounded-xl bg-slate-50 dark:bg-[#000000]/40 border border-slate-100 dark:border-white/5">
                                                <div className="flex items-center">
                                                    <div className="w-6 h-6 rounded-lg bg-slate-200 dark:bg-[#1d1f23]/60 flex items-center justify-center mr-2 text-[10px] font-bold text-slate-500 dark:text-slate-400">
                ...
                <div className="space-y-4">
                    <div className="rounded-2xl border border-dashed border-slate-300 dark:border-white/10 bg-slate-50/80 dark:bg-[#16181c]/30 backdrop-blur-sm p-5 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <span className="bg-slate-200 dark:bg-[#1d1f23]/60 text-slate-600 dark:text-slate-300 text-[10px] px-2 py-0.5 rounded-full font-bold">
