        ...
        <div className="space-y-6 max-w-4xl animate-in fade-in slide-in-from-bottom-2 duration-500">
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-slate-800/40 backdrop-blur-sm p-6 shadow-sm">
                ...
                <div className="space-y-3">
                    {apiKeys.length === 0 ? (
                        <div className="text-center py-8 rounded-2xl border border-dashed border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-slate-900/30">
                            <KeyRound className="w-8 h-8 text-gray-300 mx-auto mb-2" />
                            <p className="text-sm text-gray-500">No API keys found.</p>
                        </div>
                    ) : apiKeys.map(key => (
                        <div key={key.id} className="p-4 rounded-xl border border-slate-100 dark:border-white/5 bg-slate-50 dark:bg-slate-900/40 flex items-center justify-between" style={{ transition: 'all 250ms cubic-bezier(0.25,1,0.5,1)' }}>
                            <div className="flex items-center">
                                <div className="w-8 h-8 rounded-lg bg-slate-200 dark:bg-slate-700/60 flex items-center justify-center mr-3">
                                            ...
                                            <div className="flex gap-2">
                                                {hasPassword && (
                                                    <input
                                                        ...
                                                        className="px-2 py-1 text-[10px] bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-white/10 rounded outline-none w-32 text-gray-900 dark:text-white placeholder:text-slate-400 focus:ring-1 focus:ring-cyan-500/40"
            ...
            <div className="rounded-2xl p-6 border border-slate-200 dark:border-white/10 bg-slate-900 dark:bg-slate-900/60 shadow-xl relative overflow-hidden group">
