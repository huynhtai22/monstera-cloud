        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
            ...
            >
                ...
                <defs>
                    ...
                    <linearGradient id="stream-dim" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" stopColor="transparent" />
                        <stop offset="50%" stopColor="#a3a3a3" stopOpacity="0.5" />
                        <stop offset="100%" stopColor="transparent" />
                    </linearGradient>
                </defs>

                <g className="opacity-20 stroke-white/10" fill="none" strokeWidth="1">
                ...
                <g fill="none" strokeWidth="2" strokeLinecap="round">
                    {/* Animated data streams riding over the base paths */}
                    <path d="M-100,200 C300,300 600,-100 1300,400" stroke="url(#stream-white)" className="stream-path-1" />
                    <path d="M-100,500 C400,600 800,100 1300,300" stroke="url(#stream-dim)" className="stream-path-2" />
                    <path d="M-100,700 C200,800 500,300 1300,500" stroke="url(#stream-white)" className="stream-path-3" />
                    <path d="M100,-100 C300,200 800,800 1000,900" stroke="url(#stream-white)" className="stream-path-4" />
                    <path d="M400,-100 C600,300 1100,600 1300,800" stroke="url(#stream-dim)" className="stream-path-5" />
                </g>

                {/* Processing active nodes */}
                <g className="fill-white" opacity="0.3">
                    <circle cx="280" cy="285" r="2.5" className="animate-pulse" />
                    <circle cx="680" cy="200" r="3" className="animate-pulse" style={{ animationDuration: '3s' }} />
                    <circle cx="450" cy="460" r="2" className="animate-pulse" />
                    <circle cx="850" cy="520" r="2.5" className="animate-pulse" style={{ animationDelay: '1s' }} />
                    <circle cx="950" cy="380" r="2.5" className="animate-pulse" style={{ animationDelay: '2s' }} />
                </g>
            </svg>
        </div>
    );
