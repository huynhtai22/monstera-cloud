    ...
    return (
        <section className="border-b border-white/5 px-4 py-20 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-5xl">
                <p className="mb-3 text-center font-mono text-[10px] uppercase tracking-widest text-gray-500">Trust &amp; security</p>
                <h2 className="mb-4 text-center text-2xl font-black tracking-tight text-white md:text-3xl">
                    Built for teams who outgrow manual spreadsheets
                </h2>
                <p className="mx-auto mb-10 max-w-2xl text-center text-sm leading-relaxed text-gray-400">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
                        ...
                        <h3 className="mb-2 text-sm font-bold text-white">OAuth &amp; encryption</h3>
                        <p className="text-xs leading-relaxed text-gray-500">
                            Platform sign-in uses each vendor&apos;s OAuth. Tokens and keys are encrypted at rest. Traffic uses modern TLS. See our{" "}
                            <Link href="/legal/privacy-policy" className="text-cyan-400 underline hover:text-cyan-300">
                                Privacy Policy
                            </Link>
                            .
                        </p>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
                        ...
                        <h3 className="mb-2 text-sm font-bold text-white">What we don&apos;t do</h3>
                        <p className="text-xs leading-relaxed text-gray-500">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
                        ...
                        <h3 className="mb-2 text-sm font-bold text-white">Vs DIY exports</h3>
                        <p className="text-xs leading-relaxed text-gray-500">
                ...
                <p className="mt-8 text-center text-xs text-gray-600">
                    ...
                    <span className="font-semibold text-gray-400">Singapore, Malaysia, Indonesia, Vietnam, Thailand</span> — pricing in USD and VND
                    where available.
                </p>
            </div>
        </section>
