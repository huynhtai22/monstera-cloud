...
export function PerformanceReportDashboard({
  ...
  const handleCopyBrief = () => {
    if (!overall) return;
    const clientName = data?.client?.name || "All Brands";
    const briefText = `📊 *Executive Performance Brief: ${clientName}*
📅 Period: ${startDateStr} to ${endDateStr}
💰 Total Ad Spend: ${formatCurrencyValue(overall.totalSpend, currency)}
🛒 Total Revenue: ${formatCurrencyValue(overall.totalRevenue, currency)}
📈 Blended ROAS: ${overall.blendedRoas.toFixed(2)}x
🎯 Blended CPA: ${formatCurrencyValue(overall.blendedCpa, currency)}
📦 Total Conversions: ${overall.totalConversions.toLocaleString()}
Generated by Monstera Cloud (https://monsteracloud.com)`;
  ...
  const handleDownloadCsv = () => {
    ...
    const headers = ["Platform", "Account", "Campaign", "Spend", "Conversions", "CPA", "Revenue", "ROAS", "Currency"];
    ...
    link.setAttribute("download", `performance-report-${selectedClientId || "all"}-${startDateStr}-${endDateStr}.csv`);
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between rounded-xl border border-line bg-panel p-4 shadow-xs">
        ...
        <div className="flex items-center gap-2 self-end sm:self-auto">
          ...
          <button
            ...
            disabled={!overall || overall.totalSpend === 0}
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            ...
            <div className="rounded-xl border border-line bg-panel p-4 shadow-xs">
              ...
              <p className="mt-2 text-xl font-bold tracking-tight text-ink truncate">
                {formatCurrencyValue(overall.totalSpend, currency)}
              </p>
              <span className="text-[10px] text-ink-mute block mt-0.5">Across all ad channels</span>
            </div>
            ...
            <div className="rounded-xl border border-line bg-panel p-4 shadow-xs">
              ...
              <p className="mt-2 text-xl font-bold tracking-tight text-emerald-400 truncate">
                {formatCurrencyValue(overall.totalRevenue, currency)}
              </p>
              <span className="text-[10px] text-ink-mute block mt-0.5">Attributed sales volume</span>
            </div>
