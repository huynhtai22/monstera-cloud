    ...
    <div className="mx-auto max-w-3xl px-6 pt-28 pb-20">
      ...
      <div className="mt-10 rounded-2xl border border-slate-800 bg-slate-950/40 p-6">
        ...
        <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm text-slate-300">
          ...
          <li>
            ...
            <Link href="/console" className="text-emerald-400 hover:underline">
              Data Sources
            </Link>{" "}
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        <div className="flex gap-3 rounded-xl border border-slate-800 bg-slate-950/30 p-4">
          <KeyRound className="h-5 w-5 shrink-0 text-emerald-500" aria-hidden />
          <div>
        ...
        <div className="flex gap-3 rounded-xl border border-slate-800 bg-slate-950/30 p-4">
          <LineChart className="h-5 w-5 shrink-0 text-emerald-500" aria-hidden />
          <div>
        ...
        <div className="flex gap-3 rounded-xl border border-slate-800 bg-slate-950/30 p-4">
          <Shield className="h-5 w-5 shrink-0 text-emerald-500" aria-hidden />
          <div>
        ...
        <div className="flex gap-3 rounded-xl border border-slate-800 bg-slate-950/30 p-4">
          <BookOpen className="h-5 w-5 shrink-0 text-emerald-500" aria-hidden />
          <div>
