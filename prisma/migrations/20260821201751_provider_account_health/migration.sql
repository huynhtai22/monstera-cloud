...
-- AddForeignKey
ALTER TABLE "ProviderAccountHealth" ADD CONSTRAINT "ProviderAccountHealth_connectionId_fkey" FOREIGN KEY ("connectionId") REFERENCES "Connection"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
